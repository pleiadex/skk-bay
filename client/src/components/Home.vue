  ...
  <div>
    <v-carousel hide-delimiters>
      ...
      >
        <v-row
          ...
          justify="center"
        >
          <div class="display-2 white--text pl-5 pr-5 hidden-sm-only"><strong>Don't miss out Chirstmas Discount</strong></div><br/>
        </v-row>
      </v-carousel-item>
      <v-carousel-item
    ...
    <div class="pl-4 pr-4 row">
      ...
      >
        <v-card>
          ...
          <v-img
            :src="require('../assets/img/home/top-pick.jpg')"
      ...
      >
        <v-card>
          <v-img
            :src="require('../assets/img/home/newest.jpg')"
            class="white--text align-center"
            gradient="to bottom, rgba(0,0,0,.1), rgba(0,0,0,.5)"
            height="400px"
          >
            <h1 class="text-center font-size">Newest Products</h1>
            <div class="text-center">
              <v-btn  href="/shop" class="white--text" outlined>SHOP NOW</v-btn>
            </div>
          </v-img>
    ...
    <div class="pl-4 pr-4 row">
      ...
      >
        <v-card outlined>
          <v-img
            :src="require('../assets/img/home/shirt1.jpg')"
            class="white--text align-center"
            gradient="to bottom, rgba(0,0,0,.1), rgba(0,0,0,.5)"
            height="300px"
          >
            <h1 class="text-center font-size">Shirts</h1>
      ...
      >
        <v-card outlined>
          <v-img
            :src="require('../assets/img/home/it-device.jpg')"
            class="white--text align-center"
            gradient="to bottom, rgba(0,0,0,.1), rgba(0,0,0,.5)"
            height="300px"
          >
            <h1 class="text-center font-size">IT Device</h1>
            <div class="text-center mt-2">
              <v-btn class="white--text caption"  href="/shop" text>SHOP NOW <v-icon class="white--text caption">mdi-arrow-right</v-icon></v-btn>
            </div>
          </v-img>
      ...
      >
        <v-card outlined>
          <v-img
            :src="require('../assets/img/home/shoes.jpg')"
            class="white--text align-center"
            gradient="to bottom, rgba(0,0,0,.1), rgba(0,0,0,.5)"
            height="300px"
          >
            ...
            <div class="row">
              ...
              <div class="col-12 col-md-3 col-sm-6 col-xs-6 text-center" >
                ...
                >
                  ...
                  >
                    <v-card-title>IT Device </v-card-title>
                  </v-img>

                  <v-card-text class="text--primary text-center">
                    <div>Upto 30% + Extra 10%</div>
                    <div>Apple, Samsung, Pixel</div>
                  </v-card-text>
              ...
              <div class="col-12 col-md-3 col-sm-6 col-xs-6 text-center" >
                ...
                >
                  ...
                  >
                    <v-card-title>Furniture </v-card-title>
                  </v-img>

                  <v-card-text class="text--primary text-center">
                    <div>Upto 40% + Extra 10%</div>
                    <div>Bernhardt, Baker, Sickley</div>
                  </v-card-text>
